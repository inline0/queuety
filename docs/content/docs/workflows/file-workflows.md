...
File workflows support everything the builder supports. Delays, signals, parallel steps, conditional branching, run-workflows, cancellation handlers, and state pruning all work:
