...
description: Using named steps and _goto to branch workflow execution.
---
...
If you specifically want to jump back to an earlier step based on workflow state, see [Loops](/docs/workflows/loops). That keeps the back-edge explicit in the workflow definition instead of burying it inside a step class.
