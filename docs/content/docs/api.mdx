...
Replace the queue with an in-memory fake for testing. Returns a `QueueFake` instance that records dispatched jobs, chains, and batches without touching the database.
